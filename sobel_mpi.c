...
int main(int argc, char **argv) {
    ...
    if (rank == 0 && image.y%numtasks) {
        ...
        // Perform convolve on tail part of image
        generic_convolve((void *)&sobel_data);
